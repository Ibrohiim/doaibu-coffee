        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <?php foreach ($editsupplier as $esp) { ?>
                        <div class="card card-warning card-outline">
                            <div class="card-header">
                                <a href="<?= base_url('admin/supplier'); ?>" class="btn btn-outline-primary"><i class="fas fa-reply"></i> <strong>Back</strong>
                                </a>
                            </div>
                            <form class="form-horizontal" method="POST" action="<?= base_url('admin/supplier/editsupplier/' . $esp->id_supplier); ?>">
                                <input type="hidden" value="<?= $esp->id_supplier; ?>" id="id_supplier" name="id_supplier" class="form-control" />
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?= $esp->supplier_code; ?>" id="supplier_code" class="form-control" disabled />
                                                    <input type="hidden" value="<?= $esp->supplier_code; ?>" id="supplier_code" name="supplier_code" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="supplier_name">Supplier Name</label>
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?= $esp->supplier_name; ?>" name="supplier_name" placeholder="Input new supplier name" id="supplier_name" class="form-control <?= form_error('supplier_name') ? 'is-invalid' : null; ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?= $esp->supplier_phone; ?>" name="supplier_phone" placeholder="Input new supplier phone" id="supplier_phone" class="form-control <?= form_error('supplier_phone') ? 'is-invalid' : null; ?>" />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control <?= form_error('description') ? 'is-invalid' : null; ?>" name="description" rows="3" placeholder="Enter ..."><?= $esp->description; ?></textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control <?= form_error('supplier_address') ? 'is-invalid' : null; ?>" name="supplier_address" rows="3" placeholder="Enter ..."><?= $esp->supplier_address; ?></textarea>
                                                    <?= form_error('supplier_address', '<small class="text-danger m-r-10">', '</small>'); ?>
                                                </div>
                                            </div>
