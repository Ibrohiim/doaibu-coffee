            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-primary">
                        ...
                        <form role="form" action="<?= base_url('admin/products/categories'); ?>" method="POST">
                ...
                <div class="col-md-8">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/products/categories') ?>"><?= $title ?></a></li>
                    </ul>
