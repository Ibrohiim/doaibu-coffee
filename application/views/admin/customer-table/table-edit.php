            ...
            <div class="row">
                <div class="col-md-4">
                    <?php foreach ($edittable as $et) { ?>
                        <div class="card card-primary">
                            ...
                            <form role="form" action="<?= base_url('admin/table/savetable'); ?>" method="POST">
                ...
                <div class="col-md-8">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/table') ?>">Add new table</a></li>
                    </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a class="btn btn-warning btn-sm" href="<?= base_url('admin/table/edittable/') . $tab['id']; ?>"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-danger btn-sm button-delete" href="<?= base_url('admin/table/delete/') . $tab['id']; ?>"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
