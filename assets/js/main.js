(function ($) {
    ...
    var arrowMainMenu = $('.sidebar-arrow-main-menu');
    ...
    $(document).ready(function() {
        ...
        $('.sidebar-closebtn').click(function(e){
            $('.sidebar-menu').removeClass('sidebar-menu-show');
            $('.btn-show-menu-mobile').removeClass('is-active');
        });
    });
    ...
    $(document).ready(function() {
        $(".cartcontent").load($("base").attr("url") + 'homepage/loadcart');
        $('.add-cart').click(function() {
            var id = $(this).data("productid");
            var name = $(this).data("productname");
            var price = $(this).data("productprice");
            var bursttime = $(this).data("producttime");
            var qty = $('#' + id).val();
            $.ajax({
                url: $("base").attr("url") + 'homepage/addtocart',
                method: "POST",
                data: {
                    id: id,
                    name: name,
                ...
                success: function(data) {
                    ...
                    toastr.success("is added to cart !", name);
                }
            });
        });
    });
